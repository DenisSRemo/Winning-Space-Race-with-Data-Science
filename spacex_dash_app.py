...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',
                                                min=int(min_payload),  # Convert min_payload to int
                                                max=int(max_payload),  # Convert max_payload to int
                                                step=1000,
                                                marks={i: str(i) for i in range(int(min_payload), int(max_payload)+1, 1000)},
                                                value=[int(min_payload), int(max_payload)]),  # Convert initial values to int
